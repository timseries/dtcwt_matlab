function dtcwt_ri= dtcwt_3d_reg_interp(xa,xb, levelsel,sizeqfilt)
% reg3d_V1
...
global ya ya_before_reg % ya stores the coefs of the highpass bands after xa is DT-CWT transformed
